...
public class IdentifyObject {
    ...
    static org.slf4j.Logger log = LoggerFactory.getLogger(IdentifyObject.class);
    
    XPathHelper xml;
    HttpClient httpClient;
    
    public IdentifyObject(XPathHelper xml, HttpClient httpClient) {
        this.xml = xml;
    ...
    public void exec(RoutingContext context) throws XPathExpressionException {
        ...
        String url = Strings.join(apiUrl, "/", lang, "/search/", layer, ".json?key=", authKey, limit, "&near=", lng, ",", lat);
